...
if change == 1:
    ...
    if length_convert == 1:
        ...
        print("{} cm to {} feet.".format(length_convert,length_convert/30.48))
    elif length_convert==12:
        print("{} feet to {} inch.".format(length_convert,length_convert*12))
    else:
    ...
    if area_convert==1:
        ...
        print("{} sqft to {} sqmtrs.".format(area_value,area_value/10.764))
    elif area_convert==2:
    
        print("{} sqft to {} hectre.".format(area_value,area_value/107600))
